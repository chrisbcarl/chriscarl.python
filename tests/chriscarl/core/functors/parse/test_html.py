...
class TestCase(UnitTest):
    ...
    def setUp(self):
        self.flat_filepath = abspath(constants.TESTS_COLLATERAL_DIRPATH, 'flat.html')
        self.index_filepath = abspath(constants.TESTS_COLLATERAL_DIRPATH, 'index.html')
        self.typical_filepath = abspath(constants.TESTS_COLLATERAL_DIRPATH, 'typical.html')
