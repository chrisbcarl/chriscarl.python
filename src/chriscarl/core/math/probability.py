...
def binomial_cdf(l, n, p, precision=4):
    ...
    Description:
        ...
        $X \overset{iid}{\sim} Bin(n, p), P(X \le l) = \displaystyle\sum_{k=0}^{l}p^{k}(1-p)^{n-k}$
