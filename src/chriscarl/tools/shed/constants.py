...
tools.shed.constants is a bunch of constants I use in tools but dont make sense as part of the main library
tool are modules that define usually cli tools or mini applets that I or other people may find interesting or useful.

Updates:
    2026-01-07 - tools.shed.constants - initial commit
'''
...
SCRIPT_RELPATH = 'chriscarl/tools/shed/constants.py'
